...
export const connectMcpTool = (toolRegistry) => ({
    name: 'connectMcp',
...
export const delegateTaskTool = (client) => ({
    name: 'delegateTask',
...
export const activateSkillTool = (toolRegistry) => ({
    name: 'activateSkill',
...
export const askUserTool = {
    ...
    execute: async ({ question, type = 'text', options }) => {
        return await askUserBus.ask(question, type, options);
    },
};
